...
export default function AcademicPage() {
  ...
  const academicModules = [
    ...
    },
    {
      id: 'grades',
      title: 'Grades',
      description: 'Student performance and assessments',
      icon: FaChartBar,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-text-primary mb-2">Academic Management</h1>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className={`p-3 rounded-full ${module.bgColor}`}>
                      <IconComponent className={`text-2xl ${module.iconColor}`} />
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-bold text-text-primary">{module.stats.total}</div>
                      <div className="text-sm text-text-secondary">Total</div>
                    </div>
                  </div>
                  
                  <h3 className="text-xl font-semibold text-text-primary mb-2">{module.title}</h3>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-text-secondary">{module.stats.active} Active</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
                        <span className="text-text-secondary">{module.stats.pending} Pending</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <Card className="mt-8">
          <div className="p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-4">Recent Academic Activity</h2>
